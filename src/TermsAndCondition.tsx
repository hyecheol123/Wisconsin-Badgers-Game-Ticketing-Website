 ...
 *   - Text created by Termly's Terms and Condition Generator
 *
...
/**
 * React functional component for TermsAndCondition
 *
 * @return {React.ReactElement} Renders Landing Page
 */
function TermsAndCondition(): React.ReactElement {
  return (
    <>
      <Header />
      <Box sx={contentStyle.ContentWrapper}>
        <Box sx={contentStyle.Content}>
          <Typography variant="tcPageTitle">TERMS AND CONDITIONS</Typography>
          <Typography variant="tcCaption">
            Last updated October 19, 2022
          </Typography>

          <Typography variant="tcTitle">1. AGREEMENT TO TERMS</Typography>
          <Typography variant="tcBody">
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and __________ ("Company," “we," “us," or “our”), concerning your
            access to and use of the badgertickets.hcjang.com website as well as
          ...
          <Typography variant="tcTitle">3. USER REPRESENTATIONS</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">4. USER REGISTRATION</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">5. PROHIBITED ACTIVITIES</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">7. CONTRIBUTION LICENSE</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">8. SUBMISSIONS</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">9. SITE MANAGEMENT</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">10. TERM AND TERMINATION</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">12. GOVERNING LAW </Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">13. DISPUTE RESOLUTION</Typography>
          <Typography variant="tcSubTitle">Informal Negotiations</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcSubTitle">Binding Arbitration</Typography>
          <Typography variant="tcBody">
            ...
            Dane, Wisconsin. Except as otherwise provided herein, the Parties
          ...
          <Typography variant="tcBody">
            ...
            state and federal courts located in Dane, Wisconsin, and the Parties
          ...
          <Typography variant="tcBody">
            ...
            way to the Site be commenced more than zero (0) years after the
          ...
          <Typography variant="tcSubTitle">Restrictions</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">14. CORRECTIONS</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">15. DISCLAIMER</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">17. INDEMNIFICATION</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">18. USER DATA</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcTitle">21. MISCELLANEOUS</Typography>
          <Typography variant="tcBody">
          ...
          <Typography variant="tcBody">
            This is not the official/real website to buy Wisconsin Badger
            Ticket. The sole purpose of this website is for a group project of a
            college course (INFO SYS 371, UW-Madison Fall 2022 Semester).
          </Typography>
